      ...
      <div className={style.card_detalle_container}>
        ...
        <section className={style.seccion_2_container}>
            ...
            <div className={style.detalle_funko_container}>
              <p className={style.detalle}>Precio c/u: $5000</p>
              <p className={style.detalle}>Categoría: Marvel</p>
              <p className={style.detalle}>Valoración: 5</p>
              <p className={style.detalle}>Nro: #456</p>
              
              <div className={style.detalle_valoracion}>
              Valorar: <div>Estrellas</div>
              </div>
