            ...
            <section className={style.seccionUno_container}>
                ...
                <article className={style.texto_nosotros}>
                    <p className={style.texto}>
                        ...
                        empezamos nuestra historias en eventos de anime vendiendo distintos
                        artículos relacionados al mundo del manga y del anime, posteriormente
                        incursionamos en el mundo de los Funko Pop en el cual encontramos un nicho
                        de crecimiento, convirtiéndonos en una de los ecommerce de Funko Pop con mas
