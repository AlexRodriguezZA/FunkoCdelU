  ...
  return (
    <div className={style.Seccion_comentario_container}>
      ...
      <form className={style.comentario_container}>
        {
          session && <div className={style.input_comentario_container}>
        ...
        {
          session && <div className={style.buttons_container}>
                          <button 
                                  onClick={handleSendComentario}
                                  className={style.button_enviar} >Enviar</button>
                          <button 
                                  onClick={handleResetTextArea}
                                  className={style.button_cancelar}>Cancelar</button>
                    </div>
        }
      ...
      {ComentariosFunko.comentariosByIdprod.nodes.map( (comentario) => <Comentario key={comentario.idcomentario} comentarioData={comentario}/>)}
