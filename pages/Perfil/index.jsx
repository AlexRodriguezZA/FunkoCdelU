...
const user = ({dataUser,ciudades}) => {
  ...
  const handleSubmit = ()=> {
    updateUser(dataUser.email,Nombre,Apellido,Direccion,codigoPostal,AlturaDireccion)
  } 
    ...
    return (
      <div className={style.page_perfil}>
        ...
        <Modal openModal={open} CloseModal={ () => setOpen(false)}>
          ...
          <form className={style.modal_formulario_container} onSubmit={handleSubmit}>
            ...
            <div className={style.input_container}>
              <select className={style.input_ciudad} value={codigoPostal} onChange={ (e)=> setcodigoPostal(e.target.value)} >
        ...
        <div className={style.card_principal}>
          <div className={style.data_seccion}>
            ...
            <section className={style.seccion_2}>
              <p className={style.data_user}>Direccion: <span className={style.data_user_info}>{dataUser.direccion} {dataUser.alturadireccion}</span></p>
              <p className={style.data_user}>Dni: <span className={style.data_user_info}>{dataUser.dni}</span></p>
          ...
          <div className={style.seccion_3}>
            <button className={style.button_editar} onClick={ () => setOpen(true) }>Editar</button>
